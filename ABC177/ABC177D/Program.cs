...
namespace ABC177D
{
    public static class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                unionFind.TryUnite(a, b);
            }

            // すべてのtreeのうち、最もノード数が大きいもので決まる
            var max = unionFind.AllRepresents().Select(unionFind.GetSize).Max();
            // var max = unionFind.AllRepresents().Max(unionFind.GetSize);
